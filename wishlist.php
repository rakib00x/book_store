                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="pro-price"><span>Tk 395.00</span></td>
                                    ...
                                    <td class="pro-subtotal"><span>Tk 395.00</span></td>
                                ...
                                <tr>
                                    ...
                                    <td class="pro-price"><span>Tk 275.00</span></td>
                                    <td class="pro-quantity">
                                        <div class="pro-qty">
                                            <div class="count-input-block">
                                                <input type="number" class="form-control text-center" value="1">
                                    ...
                                    <td class="pro-subtotal"><span>TK 550.00</span></td>
                                    <td class="pro-remove"><a href="#"><i class="far fa-trash-alt"></i></a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="pro-price"><span>TK 295.00</span></td>
                                    <td class="pro-quantity">
                                        <div class="pro-qty">
                                            <div class="count-input-block">
                                                <input type="number" class="form-control text-center" value="1">
                                    ...
                                    <td class="pro-subtotal"><span>TK 295.00</span></td>
                                    <td class="pro-remove"><a href="#"><i class="far fa-trash-alt"></i></a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="pro-price"><span>TK 220.00</span></td>
                                    <td class="pro-quantity">
                                        <div class="pro-qty">
                                            <div class="count-input-block">
                                                <input type="number" class="form-control text-center" value="1">
                                    ...
                                    <td class="pro-subtotal"><span>TK 220.00</span></td>
                                    <td class="pro-remove"><a href="#"><i class="far fa-trash-alt"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
